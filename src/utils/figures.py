...
# =============================================================================
    ...
    aggregated_stats_fpath = f"""
    C:/Users/Jtyler/Downloads/visual-reinforcement-fin-decision-making/experiments/{experiment_name}/aggregated_results
    """
    
    portfolio_factors_fpath = f"""C:/Users/Jtyler/Downloads/visual-reinforcement-fin-decision-making/experiments/{experiment_name}/portfolio_factors"""

    # save_path = f"""C:/Users/Jtyler/Downloads/visual-reinforcement-fin-decision-making/experiments/{experiment_name}/figures"""
    
    
    # plot_normalized_test_lines(portfolio_factors_fpath, save_path)
    
    
    # agg = r"C:/Users/Jtyler/Downloads/visual-reinforcement-fin-decision-making/experiments/Mini/aggregated_results"
    
    # save_path = f"""C:/Users/Jtyler/Downloads/visual-reinforcement-fin-decision-making/experiments/{experiment_name}/tables"""

    
    # convert_to_latex_table(
    #     aggregated_results_file = agg,
